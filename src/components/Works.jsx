...
const ProjectCard = ({ index, name, description, tags, image, source_code_link }) => {
  return (
    <motion.div
      variants={simpleFadeIn(index * 0.01, 0.02)} // Only fade-in with slight stagger
      initial="hidden"
      whileInView="show"
...
const Works = () => {
  return (
    <>
      ...
      <motion.div
  variants={simpleFadeIn(0.01, 0.02)} // simple fade-in for heading
  initial="hidden"
  whileInView="show"
  viewport={{ once: true, amount: 0.01 }}
...
<div className="w-full flex justify-center">
  <motion.p 
    variants={simpleFadeIn(0.01, 0.02)} // fade-in description after heading
    initial="hidden"
    whileInView="show"
    viewport={{ once: true, amount: 0.01 }}
