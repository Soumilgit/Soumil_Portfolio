...
const AchievementCard = ({ index, name, description, link }) => (
  <motion.div
    variants={simpleFadeIn(index * 0.01, 0.02)} // Only fade in with stagger
    initial="hidden"
    whileInView="show"
...
const Achieve = () => {
  return (
    <>
      ...
      <motion.div
  variants={simpleFadeIn(0.01, 0.02)} // Fade in for heading block
  initial="hidden"
  whileInView="show"
  viewport={{ once: true, amount: 0.01 }}
...
>
  ...
  <h2 className={`${styles.sectionHeadText} text-center text-white`}>
    Honours & Achievements
      ...
      <motion.div
  variants={simpleFadeIn(0.01, 0.02)} // Slight delay after heading
  initial="hidden"
  whileInView="show"
  viewport={{ once: true, amount: 0.01 }}
