...
<motion.p
  ...
  whileInView="show"
  viewport={{ once: true, amount: 0.1 }}
  className="mt-2 text-[#ABF7B1] text-xl max-w-3xl leading-7 transition-all duration-300 hover:text-[#37b54a] hover:shadow-[0_0_10px_#39FF14]"
>
  Oh, and yes, have fun experiencing neon glow effects while hovering on title-like text elements on all cards below, just like on THIS exact sentence !
</motion.p>
