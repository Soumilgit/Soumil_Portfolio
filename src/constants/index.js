...
const achievements = [
  ...
  },
  {
    ...
    description:
      "Stats: 470+ DSA problems solved, 5+ awards, 3800+ dev contributions & C-Score of 770+ among 16,500+ global users.",
...
const projects = [
  {
    ...
    description:
      "Gemini delivers interview feedback via Next, NeonDB, Docker, Clerk, Stripe, Tailwind & ShadCN across 50+ roles.",
    tags: [
      {
        name: "next",
