...
const achievements = [
  ...
  },
  {
    ...
    description:
      "Stats: 450+ DSA problems solved, 5+ awards, 3000+ dev contributions & C-Score of 750+ among 12,000+ global users.",
...
const projects = [
  ...
  },
  {
    name: "Customer Churn",
    description:
      "Analyzes 4,000 bank customer records via Python, Supabase, HTML/CSS & Mistral 24B, averaging 82.73% accuracy.",
    tags: [
      {
        name: "xgb",
        color: "green-text-gradient", 
